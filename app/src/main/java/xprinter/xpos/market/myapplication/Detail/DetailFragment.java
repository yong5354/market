...
public class DetailFragment extends Fragment implements DetailFragmentContract.DetailView {
    ...
    @Bind(R.id.app_header_download)
    ImageButton appHeaderDownload;
    ...
    public void updateContent(ApkField apkfile) {
        if(apkfile != null) {
            //icon
            Glide.with(mContext)
                    .load(apkfile.getMeta().getLogo())
                    .placeholder(R.drawable.ic_default_avatar)
                    .into(appHeaderIcon);
            //title
            appHeaderTitle.setText(apkfile.getMeta().getTitle());
            //star
            appHeaderRatingStar.setRating(Float.parseFloat(apkfile.getMeta().getStar()));
            //info
            appHeaderInfo.setText(apkfile.getMeta().getApkversionname());
            //screenshot
            ...
            sb.append("<br/><strong>").append(apkfile.getMeta().getApkversionname()).append(" :</strong><br/>")
